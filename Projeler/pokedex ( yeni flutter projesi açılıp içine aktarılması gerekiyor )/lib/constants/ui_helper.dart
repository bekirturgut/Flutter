...
class UIHelper {
  ...
  static double getAppTitleWidgetHeight(BuildContext context) {
  Orientation orientation = MediaQuery.of(context).orientation; // MediaQuery kullanımı
  return orientation == Orientation.portrait ? 0.15 : 0.10;
}
